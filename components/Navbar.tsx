...
export default function Navbar() {
  ...
  const handleNavClick = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    if (href.startsWith("/#") || href.startsWith("#")) {
      ...
      // If currently on homepage, smooth scroll and open details directly
      if (pathname === "/") {
        e.preventDefault();
        ...
        <div className="flex justify-between items-center w-full">
          ...
          <div className="hidden md:flex items-center gap-6 text-lg text-zinc-600 dark:text-zinc-400">
            ...
            <a
              ...
              aria-label="GitHub"
              className="hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors ml-2"
            >
        ...
        {isOpen && (
          <div className="md:hidden flex flex-col mt-4 pt-4 border-t border-zinc-200 dark:border-zinc-800 gap-4 text-lg text-zinc-600 dark:text-zinc-400 pb-2">
            <Link
              ...
              className="hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors px-2 py-1"
            >
              blog
            </Link>
            <Link
