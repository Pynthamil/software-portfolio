    ...
    <div className="flex flex-col flex-1 items-center bg-[#F7F6F4] font-mono dark:bg-[#0a0a0a] px-6 pt-28 md:pt-32 pb-16 w-full">
      <article className="max-w-2xl w-full text-left flex flex-col gap-10">
        ...
        <div className="prose prose-zinc dark:prose-invert font-mono text-zinc-700 dark:text-zinc-300 flex flex-col gap-8 text-lg leading-relaxed">
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">What even is a commit?</h2>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Basic Commands (tiny cheat sheet)</h2>
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm overflow-x-auto">
              <code className="text-blue-600 dark:text-blue-400">git init<br/>git add .<br/>git commit -m "message"<br/>git push origin main</code>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Step 1 — Initialize the repository</h2>
            ...
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm overflow-x-auto">
              <code className="text-blue-600 dark:text-blue-400">git init</code>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Step 2 — Stage the files</h2>
            ...
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm overflow-x-auto">
              <code className="text-blue-600 dark:text-blue-400">git add .</code>
            </div>
            <p>or specific files</p>
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm overflow-x-auto">
              <code className="text-blue-600 dark:text-blue-400">git add index.js</code>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Step 3 — Write meaningful commit messages</h2>
            ...
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm overflow-x-auto">
              <code className="text-green-600 dark:text-green-400">feat: add profile picture upload<br/>fix: correct typo in navbar<br/>chore: update dependencies</code>
            </div>
            ...
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm overflow-x-auto mt-4">
              <code className="text-blue-600 dark:text-blue-400">git commit -m "feat: add search bar"</code>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Step 4 — Push changes to GitHub</h2>
            ...
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm overflow-x-auto">
              <code className="text-blue-600 dark:text-blue-400">git push origin main</code>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Creating a repository on GitHub</h2>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Working in collaborative environments (pull requests)</h2>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Always sync before starting work</h2>
            ...
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm overflow-x-auto">
              <code className="text-blue-600 dark:text-blue-400">git pull origin main</code>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Quick summary workflow</h2>
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 text-sm overflow-x-auto">
              <code className="text-blue-600 dark:text-blue-400">git init<br/>git add .<br/>git commit -m "I'm so done"<br/>git push origin main</code>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Helpful learning resources</h2>
            
            <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-50 mt-2">Articles / Blogs</h3>
            <ul style={{ listStyleType: '"+ "' }} className="ml-5 space-y-2 text-zinc-600 dark:text-zinc-400">
              <li><a href="#" className="text-blue-600 hover:underline dark:text-blue-400">Complete Tutorial of Git and GitHub for Basic to Advanced — Sachinsoni</a></li>
              <li><a href="#" className="text-blue-600 hover:underline dark:text-blue-400">I don’t Git it — Rick Martinez</a></li>
              <li><a href="#" className="text-blue-600 hover:underline dark:text-blue-400">Git Full Tutorial — How to Use Git in a Real Project — Saikiran Kalidindi</a></li>
            </ul>

            <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-50 mt-4">YouTube Tutorials</h3>
            <ul style={{ listStyleType: '"+ "' }} className="ml-5 space-y-2 text-zinc-600 dark:text-zinc-400">
              <li><a href="#" className="text-blue-600 hover:underline dark:text-blue-400">Git and GitHub Crash Course — freeCodeCamp</a></li>
              <li><a href="#" className="text-blue-600 hover:underline dark:text-blue-400">Git and GitHub for beginners — Amigoscode</a></li>
              <li><a href="#" className="text-blue-600 hover:underline dark:text-blue-400">Git and GitHub course — Javascript Mastery</a></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 [font-family:var(--font-dm-sans)]">Bonus: customizing your GitHub README</h2>
            ...
            <p>
              <Link href="/blog/readme-aesthetic" className="text-blue-600 hover:underline dark:text-blue-400 font-bold break-all">
